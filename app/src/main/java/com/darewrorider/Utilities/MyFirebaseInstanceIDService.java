...
public class MyFirebaseInstanceIDService extends FirebaseInstanceIdService {
    ...
    public void onTokenRefresh() {
        ...
        customerID = mySharedPreferences.getRiderID(this);
    ...
    private void sendRegistrationToServer(int id) {
        ...
        webService.customerUpdateTokenKey(getResources().getString(R.string.url) + "rider_token_update", String.valueOf(id),refreshedToken, new WebService.VolleyResponseListener() {
