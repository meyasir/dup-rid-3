...
public class OrdersHistoryListViewAdapter extends BaseAdapter {
    ...
    public OrdersHistoryListViewAdapter(Context context,
    ...
    public View getView(final int position, View view, ViewGroup parent) {
        ...
        if (view == null) {
            ...
            view = inflater.inflate(R.layout.adapter_orders_history, null);
